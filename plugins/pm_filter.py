...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🦋¢нαииєℓ🦋', url='https://t.me/KL_MOVIES_MAIN_GROUP'),
            InlineKeyboardButton('🦋𝖌𝖗𝖔𝖚𝖕🦋', url='https://t.me/KL_MOVIES_MAIN_GROUP')
            ],[      
            InlineKeyboardButton('🐬𝖍𝖊𝖑𝖕🐬', callback_data='help'),
            InlineKeyboardButton('🐬𝖆𝖇𝖔𝖚𝖙🐬', callback_data='about')
            ],[
            InlineKeyboardButton('❤️‍🔥𝖏𝖔𝖎𝖓 𝖒𝖞 𝖌𝖗𝖔𝖚𝖕❤️‍🔥', url='https://t.me/KL_MOVIES_MAIN_GROUP')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons= [[
            InlineKeyboardButton('📁 ѕσυя¢є ¢σ∂є 📁', url='😁നോക്കണ്ടാ അത് ഇവിടെ ഇല്ല 😁')
            ],[
